...
%..............................
\paragraph{Compensated own price elasticity of energy service demand ($\eqspsC$)} 
...
\begin{equation} \label{eq:epsqsC_def}
...
with respect to energy service price~($\amacro{p}_s$) at constant utility ($\rate{u} = \rbsub{u} = \rasub{u}$)
across the substitution effect.
...
Forming the elasticity via its definition (Eq.~(\ref{eq:epsqsC_def})) gives
...
%..............................
\paragraph{Compensated cross price elasticity of energy service demand ($\eqopsC$)} 
