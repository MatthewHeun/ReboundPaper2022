...
a constant price elasticity (CPE) model and 
a constant elasticity of substitution (CES) model.
Within those utility models, 
price ($\varepsilon$) and substitution ($\sigma$) elasticities
describe consumer preferences.

Price elasticities apply to both utility models (CPE and CES) and 
...
In the context of rebound, substitution is considered between
consumption of the energy service and a basket of other goods.
