...
elasticity becomes more negative.%
% more negative as what happens? As p_s gets smaller or something like that?
\footnote{
...
% becomes less positive as what happens? As p_s gets smaller or something like that?
