...
for the purposes of the derivative. 
...
\begin{align}
  ...
  m &\equiv \frac{\rho}{1 - \rho} \; , \\
  n &\equiv - \frac{1}{\rho} \; , \; \mathrm{and} \\
...
\begin{equation} \label{eq:eqspsC_exact}
  \eqspsC = - \frac{\frac{1}{1 - \rho} \left( 1 - \fCs \right) \left[ \frac{1 - \fCs}{\fCs} \frac{\rorig{q}_s \amacro{p}_s}{\rorig{C}_o} \right] ^ {\frac{\rho}{1 - \rho}} }{\fCs + \left( 1 - \fCs \right) \left[ \frac{1 - \fCs}{\fCs} \frac{\rorig{q}_s \amacro{p}_s}{\rorig{C}_o} \right] ^ {\frac{\rho}{1 - \rho}} } \; .
\end{equation}
