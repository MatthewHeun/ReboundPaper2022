...
# Re_graph_params[["dsub_colour"]] <- "black"
# Re_graph_params[["isub_colour"]] <- "black"
# Re_graph_params[["dinc_colour"]] <- "black"
# Re_graph_params[["iinc_colour"]] <- "black"
# Re_graph_params[["macro_colour"]] <- "black"
# 
# Re_graph_params[["dempl_linewidth"]] <- 0.1
# Re_graph_params[["emb_linewidth"]] <- 0.1
# Re_graph_params[["dsub_linewidth"]] <- 0.3
# Re_graph_params[["isub_linewidth"]] <- 0.3
# Re_graph_params[["dinc_linewidth"]] <- 0.5
# Re_graph_params[["iinc_linewidth"]] <- 0.5
# Re_graph_params[["macro_linewidth"]] <- 1
# 
# Re_graph_params[["tot_linewidth"]] <- 1.5
