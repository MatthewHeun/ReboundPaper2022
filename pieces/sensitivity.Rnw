...
<<eta_tilde_takeback_Sdot_sens_graph, echo=FALSE, fig.cap="Expected energy savings rate ($\\Sdot$, solid line) and takeback rate (dashed line) sensitivity to post-EEU efficiency ($\\amacro{\\eta}$). The macro factor, $k = 3$. (Note different $x$- and $y$-axis scales.)", fig.width=6, fig.height=4, fig.align="center">>=
...
<<all_Re_terms_eta_graph, echo=FALSE, fig.cap="Sensitivity of rebound components to post-EEU efficiency ($\\amacro{\\eta}$). The macro factor, $k = 3$.", fig.width=6, fig.height=4, fig.align="center">>=
...
<<all_Re_terms_C_cap_graph, echo=FALSE, fig.cap="Sensitivity of rebound components to capital cost ($\\amacro{C}_{cap}$). The macro factor, $k = 3$.", fig.width=6, fig.height=4, fig.align="center">>=
...
<<all_Re_terms_eps_graph, echo=FALSE, fig.cap="Sensitivity of rebound components to uncompensated own price elasticity of energy service demand ($\\eqspsUCorig$). The macro factor, $k = 3$. (Note reversed $x$-axis scale.)", fig.width=6, fig.height=4, fig.align="center">>=
