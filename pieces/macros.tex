...
%%%%% Eliminate separating rule for footnotes
...
\newcommand{\eqgpsUC}{\varepsilon_{\rate{q}_g\!,p_s}}
\newcommand{\eqspsC}{\varepsilon_{\rate{q}_s\!,p_s\!,c}}
\newcommand{\eqgpsC}{\varepsilon_{\rate{q}_g\!,p_s\!,c}}

% originally
\newcommand{\eqspsUCorig}{\varepsilon^\circ_{\rate{q}_s\!,p_s}}
\newcommand{\eqgpsUCorig}{\varepsilon^\circ_{\rate{q}_g\!,p_s}}
\newcommand{\eqspsCorig}{\varepsilon^\circ_{\rate{q}_s\!,p_s\!,c}}
\newcommand{\eqgpsCorig}{\varepsilon^\circ_{\rate{q}_g\!,p_s\!,c}}
% With hats
\newcommand{\eqspsUChat}{\hat{\varepsilon}_{\rate{q}_s\!,p_s}}
\newcommand{\eqgpsUChat}{\hat{\varepsilon}_{\rate{q}_g\!,p_s}}
\newcommand{\eqspsChat}{\hat{\varepsilon}_{\rate{q}_s\!,p_s\!,c}}
\newcommand{\eqgpsChat}{\hat{\varepsilon}_{\rate{q}_g\!,p_s\!,c}}

\newcommand{\eqsM}{\varepsilon_{\rate{q}_s\!,\rate{M}}}
\newcommand{\eqgM}{\varepsilon_{\rate{q}_g\!,\rate{M}}}
...
% Viridis "plasma" colours
% \definecolor{emplbgcolor}{HTML}{150789}  % Blue
% \definecolor{subbgcolor}{HTML}{99149F}   % Purple
% \definecolor{incbgcolor}{HTML}{E76F5A}   % Orange
% \definecolor{macrobgcolor}{HTML}{F7E225} % Yellow
% 
% \definecolor{emplsegcolor}{HTML}{150789}  % Blue
% \definecolor{subsegcolor}{HTML}{99149F}   % Purple
% \definecolor{incsetcolor}{HTML}{E76F5A}   % Orange
% \definecolor{macrosegcolor}{HTML}{F7E225} % Yellow
%
%% \definecolor{empltextcolor}{HTML}{FFFFFF}   % White
% \definecolor{subtextcolor}{HTML}{FFFFFF}    % White
% \definecolor{inctextcolor}{HTML}{000000}    % Black
% \definecolor{macrotextcolor}{HTML}{000000} % Black

% Black-and-white colours
\definecolor{emplbgcolor}{HTML}{FFFFFF}  % White
\definecolor{subbgcolor}{HTML}{FFFFFF}   % White
\definecolor{incbgcolor}{HTML}{FFFFFF}   % White
\definecolor{macrobgcolor}{HTML}{FFFFFF} % White

\definecolor{emplsegcolor}{HTML}{000000}  % Black
\definecolor{subsegcolor}{HTML}{000000}   % Black
\definecolor{incsegcolor}{HTML}{000000}   % Black
\definecolor{macrosegcolor}{HTML}{000000} % Black

\definecolor{empltextcolor}{HTML}{000000}  % Black
\definecolor{subtextcolor}{HTML}{000000}   % Black
\definecolor{inctextcolor}{HTML}{000000}   % Black
\definecolor{macrotextcolor}{HTML}{000000} % Black
...
% Emplacement effect
\newcommand{\empleffect}{\inlinebox[emplbgcolor]{\textcolor{empltextcolor}{emplacement effect}}}
\newcommand{\empleffectadj}{\inlinebox[emplbgcolor]{\textcolor{empltextcolor}{emplacement-effect}}}
\newcommand{\Empleffect}{\inlinebox[emplbgcolor]{\textcolor{empltextcolor}{Emplacement effect}}}
\newcommand{\EmplEffect}{\inlinebox[emplbgcolor]{\textcolor{empltextcolor}{Emplacement Effect}}}

% Substitution effect
\newcommand{\subeffect}{\inlinebox[subbgcolor]{\textcolor{subtextcolor}{substitution effect}}}
\newcommand{\subeffectadj}{\inlinebox[subbgcolor]{\textcolor{subtextcolor}{substitution-effect}}}
\newcommand{\Subeffect}{\inlinebox[subbgcolor]{\textcolor{subtextcolor}{Substitution effect}}}
\newcommand{\SubEffect}{\inlinebox[subbgcolor]{\textcolor{subtextcolor}{Substitution Effect}}}

% Income effect
\newcommand{\inceffect}{\inlinebox[incbgcolor]{\textcolor{inctextcolor}{income effect}}}
\newcommand{\inceffectadj}{\inlinebox[incbgcolor]{\textcolor{inctextcolor}{income-effect}}}
\newcommand{\Inceffect}{\inlinebox[incbgcolor]{\textcolor{inctextcolor}{Income effect}}}
\newcommand{\IncEffect}{\inlinebox[incbgcolor]{\textcolor{inctextcolor}{Income Effect}}}

% Macro effect
\newcommand{\macroeffect}{\inlinebox[macrobgcolor]{\textcolor{macrotextcolor}{macro effect}}}
\newcommand{\macroeffectadj}{\inlinebox[macrobgcolor]{\textcolor{macrotextcolor}{macro-effect}}}
\newcommand{\Macroeffect}{\inlinebox[macrobgcolor]{\textcolor{macrotextcolor}{Macro effect}}}
\newcommand{\MacroEffect}{\inlinebox[macrobgcolor]{\textcolor{macrotextcolor}{Macro Effect}}}
...
\newcommand{\etaratiostacked}{\frac{\aempl{\eta}}{\bempl{\eta}}}
\newcommand{\etaratiostackedhat}{\frac{\asub{\eta}}{\bempl{\eta}}}
\newcommand{\etaratiostackedbar}{\frac{\ainc{\eta}}{\bempl{\eta}}}
...
% Original
\newcommand{\Eacctorig}{\rbempl{E} = \rbempl{E}_s + \rbempl{E}_{emb} + (\rbempl{C}_{\omd} + \rbempl{C}_g) I_E}
\newcommand{\Macctorig}{\rate{M} = p_E \rbempl{E}_s + \bempl{\tau}_\alpha \rbempl{C}_{cap} + \rbempl{C}_{\omd} + \rbempl{C}_g + \rbempl{N}}
...
\newcommand{\Eacctaempl}{\raempl{E} = \raempl{E}_s + \raempl{E}_{emb} + (\raempl{C}_{\omd} + \raempl{C}_g) I_E}                  
\newcommand{\Macctaempl}{\rate{M} = p_E \raempl{E}_s + \aempl{\tau}_\alpha \raempl{C}_{cap} + \raempl{C}_{\omd} + \raempl{C}_g + \raempl{N}}         
...
\newcommand{\Eacctasub}{\rasub{E} = \rasub{E}_s + \rasub{E}_{emb} + (\rasub{C}_{\omd} + \rasub{C}_g) I_E}
\newcommand{\Macctasub}{\rate{M} = p_E \rasub{E}_s + \asub{\tau}_\alpha \rasub{C}_{cap} + \rasub{C}_{\omd} + \rasub{C}_g + \rasub{N}}
...
% After income effect
\newcommand{\Eacctainc}{\rainc{E} = \rainc{E}_s + \rainc{E}_{emb} + (\rainc{C}_{\omd} + \rainc{C}_g) I_E}
\newcommand{\Macctainc}{\rate{M} = p_E \rainc{E}_s + \ainc{\tau}_\alpha \rainc{C}_{cap} + \rainc{C}_{\omd} + \rainc{C}_g + \rainc{N}}
...
\newcommand{\Sdoteqn}{\left( \etaratiostacked - 1 \right)\! 
                            \frac{\bempl{\eta}}{\aempl{\eta}} \rbempl{E}_s}
...
\newcommand{\cesutility}{\left[ \fCs \left( \frac{\rate{q}_s}{\rbempl{q}_s} \right)^\rho 
        + (1-\fCs) \left( \frac{\rate{C}_g}{\rbempl{C}_g} \right)^\rho  \right]^{(1/\rho)}}
...
% Equation for C_g_hat/C_g_orig
\newcommand{\Cgsolution}{ \left( 1 + \fCs \left\{ \left[ \left( \frac{1-\fCs}{\fCs} \right)
          \frac{\aempl{p}_s \rbempl{q}_s}{\rbempl{C}_g} \right] ^{\rho/(\rho - 1)} - 1 \right\} \right)^{-1/\rho}}

% Equation for Re_dsub for the CES utility model
\newcommand{\RedsubCES}{\frac{\qssolution{} - 1}{\etaratiostackedhat{} - 1}}

% Equation for Re_isub for the CES utility model
\newcommand{\ReisubCES}{\frac{\Cgsolution{} - 1}{\etaratiostackedhat{} - 1}
                         \etaratiostackedhat \; 
                          \frac{\rbempl{C}_g I_E}{\rbempl{E}_s}}
...
\newcommand{\Redinceqnexact}{& \frac{ \left( 1 + \frac{\rbinc{N}}{\Mdothatprime} \right) ^{\eqsM} - 1}
              { \etaratiostacked - 1 } \; \times \nonumber \\
              & \qssolution{} }

% Equation for Re_cap
\newcommand{\Recapeqn}{\frac{\Delta \aempl{(\tau_\alpha \rate{C}_{cap})} I_E}{\Sdot}}

% Equation for Re_iinc, approximate method
\newcommand{\Reiinceqnapprox}{\frac{\left( 1 + \frac{\rbinc{N}}{\Mdothatprime} \right)^{\eqgM} - 1}{\etaratiostacked - 1} 
              \left( \etaratiostacked \right)^{1 - \eqgpsC}
              \frac{\rbempl{C}_g I_E}{\rbempl{E}_s}}

% Equation for Re_iinc, exact method
\newcommand{\Reiinceqnexact}{& \frac{\left( 1 + \frac{\rbinc{N}}{\Mdothatprime} \right)^{\eqgM} - 1}{\etaratiostacked - 1} 
              \left( \etaratiostacked \right)
              \frac{\rbempl{C}_g I_E}{\rbempl{E}_s} \; \times \nonumber \\
              & \Cgsolution{}}
...
% Equation for Re_tot
\newcommand{\Retoteqn}{& Re_{emb} + k (p_E I_E - Re_{cap}) + (1-k) Re_{\omd} \; + \nonumber \\ 
                       & Re_{dsub} + Re_{isub} + Re_{dinc} + Re_{iinc}}
...
\newcommand{\incprefoeqn}{\frac{\rainc{q}_g}{\rbinc{q}_g} = \left( 1 + \frac{\rbinc{N}}{\Mdothatprime}  \right) ^{\eqgM}}

% Equation for effective income
\newcommand{\effinceqn}{\Mdothatprime \equiv \rate{M} - \aempl{\tau}_\alpha \raempl{C}_{cap} - \raempl{C}_{\omd} - \rasub{N}}
...
\newcommand{\budgetconstraint}{\rate{M} - \orig{\tau}_\alpha \rorig{C}_{cap} - \rorig{C}_{\omd} = \orig{p}_E \frac{\rorig{q}_s}{\orig{\eta}} + p_g \rorig{q}_g}
...
\newcommand{\hathatline}{\seg{$\wedge$}{black}{0.1 mm}{$\wedge$}}
\newcommand{\barbarline}{\seg{$-\,$}{black}{0.1 mm}{$\, -$}}

% Line segments
\newcommand{\circa}{\seg{$\circ$}{emplsegcolor}{0.6 mm}{$a$}}
\newcommand{\ab}{$a$\tikz[baseline=-0.6ex]\draw [line width=0.6mm,dotted,emplsegcolor] (0,0) -- (0.45,0);$b$}
\newcommand{\bstar}{\seg{$b\,$}{emplsegcolor}{0.6 mm}{$*$}}
\newcommand{\starc}{\seg{$*$}{subsegcolor}{0.6 mm}{$\,c$}}
\newcommand{\chat}{\seg{$c\,$}{subsegcolor}{0.6 mm}{$\wedge$}}
\newcommand{\hatd}{\seg{$\wedge$}{incsegcolor}{0.6 mm}{$\,d$}}
\newcommand{\dbar}{\seg{$d$}{incsegcolor}{0.6 mm}{$\,-$}}
\newcommand{\hatbarline}{\seg{$\wedge$}{incsegcolor}{0.6 mm}{$\,-$}}
\newcommand{\bartildeline}{\seg{$- \,$}{macrosegcolor}{0.6 mm}{$\, \sim$}}
...
% Macros needed only for compatibility
% with previous versions of the paper
% (prior to the "o" --> "g" shift in subscript nomenclature).
% Needed for creating diffs
