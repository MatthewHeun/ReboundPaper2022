...
\newcommand{\Macctorig}{\rbempl{M} = p_E \rbempl{E}_s + \bempl{R}_\alpha \rbempl{C}_{cap} + \rbempl{C}_{\omd} + \rbempl{C}_o + \rbempl{N}}
...
\newcommand{\Macctaempl}{\raempl{M} = p_E \raempl{E}_s + \aempl{R}_\alpha \raempl{C}_{cap} + \raempl{C}_{\omd} + \raempl{C}_o + \raempl{N}}         
...
\newcommand{\Macctasub}{\rasub{M} = p_E \rasub{E}_s + \asub{R}_\alpha \rasub{C}_{cap} + \rasub{C}_{\omd} + \rasub{C}_o + \rasub{N}}
...
\newcommand{\Macctainc}{\rainc{M} = p_E \rainc{E}_s + \ainc{R}_\alpha \rainc{C}_{cap} + \rainc{C}_{\omd} + \rainc{C}_o + \rainc{N}}
...
%                        &+ Re_{dsub} + Re_{isub}                              \nonumber \\
%                        &+ Re_{dinc} + Re_{iinc}}
\newcommand{\Retoteqn}{Re_{emb} + k (p_E I_E - Re_{cap}) + (1-k) Re_{\md} + Re_{dsub} + Re_{isub} + Re_{dinc} + Re_{iinc}}
...
\newcommand{\effinceqn}{\Mdothatprime \equiv \rorig{M} - \aempl{R}_\alpha \raempl{C}_{cap} - \raempl{C}_{\omd} - \rasub{N}}
...
\newcommand{\kyr}{k\,\mathrm{yr}}

\newcommand{\budgetconstraint}{\rate{M} - R_\alpha \rate{C}_{cap} - \rate{C}_{\om} - R_\omega \rate{C}_d = p_s \rate{q}_s + p_o \rate{q}_o}
