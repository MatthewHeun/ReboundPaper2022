...
\newcommand{\eqspsUC}{\epsilon_{\rate{q}_s\!,p_s}}
\newcommand{\eqopsUC}{\epsilon_{\rate{q}_o\!,p_s}}
\newcommand{\eqspsC}{\epsilon_{\rate{q}_s\!,p_s\!,c}}
\newcommand{\eqopsC}{\epsilon_{\rate{q}_o\!,p_s\!,c}}
...
\newcommand{\Cosolution}{\left[ \left( 1 + \fCs \left\{ \left[ \left( \frac{1-\fCs}{\fCs} \right)
          \frac{\amacro{p}_s \rbempl{q}_s}{\rbempl{C}_o} \right] ^{1-\sigma} - 1 \right\} \right)^{-1}  \right] 
                                                ^{1/\rho}}
...
\newcommand{\Retoteqn}{&Re_{emb} + k p_E I_E - k Re_{cap} + (1-k) Re_{\md}   \nonumber \\
                       &+ Re_{dsub} + Re_{isub}                              \nonumber \\
                       &+ Re_{dinc} + Re_{iinc}}
