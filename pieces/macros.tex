...
% \definecolor{emplcolor}{HTML}{150789}  % Blue
% \definecolor{subcolor}{HTML}{99149F}   % Purple
% \definecolor{inccolor}{HTML}{E76F5A}   % Orange
% \definecolor{macrocolor}{HTML}{F7E225} % Yellow
% 
...
\definecolor{emplcolor}{HTML}{FFFFFF}  % White
\definecolor{subcolor}{HTML}{FFFFFF}   % White
\definecolor{inccolor}{HTML}{FFFFFF}   % White
\definecolor{macrocolor}{HTML}{FFFFFF} % White
...
% Emplacement effect
\newcommand{\empleffect}{\inlinebox[emplcolor]{\textcolor{empltextcolor}{emplacement effect}}}
\newcommand{\empleffectadj}{\inlinebox[emplcolor]{\textcolor{empltextcolor}{emplacement-effect}}}
\newcommand{\Empleffect}{\inlinebox[emplcolor]{\textcolor{empltextcolor}{Emplacement effect}}}
\newcommand{\EmplEffect}{\inlinebox[emplcolor]{\textcolor{empltextcolor}{Emplacement Effect}}}

% Substitution effect
\newcommand{\subeffect}{\inlinebox[subcolor]{\textcolor{subtextcolor}{substitution effect}}}
\newcommand{\subeffectadj}{\inlinebox[subcolor]{\textcolor{subtextcolor}{substitution-effect}}}
\newcommand{\Subeffect}{\inlinebox[subcolor]{\textcolor{subtextcolor}{Substitution effect}}}
\newcommand{\SubEffect}{\inlinebox[subcolor]{\textcolor{subtextcolor}{Substitution Effect}}}

% Income effect
\newcommand{\inceffect}{\inlinebox[inccolor]{\textcolor{inctextcolor}{income effect}}}
\newcommand{\inceffectadj}{\inlinebox[inccolor]{\textcolor{inctextcolor}{income-effect}}}
\newcommand{\Inceffect}{\inlinebox[inccolor]{\textcolor{inctextcolor}{Income effect}}}
\newcommand{\IncEffect}{\inlinebox[inccolor]{\textcolor{inctextcolor}{Income Effect}}}

% Macro effect
\newcommand{\macroeffect}{\inlinebox[macrocolor]{\textcolor{macrotextcolor}{macro effect}}}
\newcommand{\macroeffectadj}{\inlinebox[macrocolor]{\textcolor{macrotextcolor}{macro-effect}}}
\newcommand{\Macroeffect}{\inlinebox[macrocolor]{\textcolor{macrotextcolor}{Macro effect}}}
\newcommand{\MacroEffect}{\inlinebox[macrocolor]{\textcolor{macrotextcolor}{Macro Effect}}}
...
\newcommand{\hatbarline}{\seg{$\wedge$}{inccolor}{0.6 mm}{$\,-$}}
\newcommand{\bartildeline}{\seg{$- \,$}{macrocolor}{0.6 mm}{$\, \sim$}}
