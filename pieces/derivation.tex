...
Solving for $\rasub{C}_o/\rbsub{C}_o$,
...
\begin{equation}
  Re_{isub} = - \frac{\rbsub{q}_s \rorig{C}_o p_E I_E}{\orig{\eta} \rbsub{C}_o \rorig{E}_s} Re_{dsub}
\end{equation}
...
like in the fully satiated case discussed 
