...
\input{pieces/budget_constraint.tex}
...
expenditure on other goods is reduced by
...
\begin{equation}
  \Delta \rasub{C}_o = - \Delta \rasub{C}_s \; .
\end{equation}
%
The advantage of this approach is that 
no cross price elasticity is needed. 
The disadvantage is that it further moves away
from the definition of the substitution effect, 
...
\end{equation}
%
solving for $\rasub{C}_o/\rbsub{C}_o$, and 
...
\begin{equation}
  Re_{isub} = - \frac{\frac{p_E \rbsub{q}_s}{\amacro{\eta} \rbsub{C}_o}
                   \left[ \left( \etaratiostacked \right)^{-\eqspsUC} - 1   \right] }
                {\etaratiostacked - 1} 
                \etaratiostacked 
                \frac{\rorig{C}_o I_E}{\rorig{E}_s} \; .
\end{equation}
%
...
\begin{equation}
  Re_{isub} = - Re_{dsub} \frac{\rbsub{q}_s \rorig{C}_o p_E I_E}{\orig{\eta} \rbsub{C}_o \rorig{E}_s}
\end{equation}
%
...
% The change in expenditure under the CPE utility model 
% can be expressed as
% 
% \begin{equation}
