...
<<CarReFormatter, include=FALSE>>=
# Function to extract and format numbers for the lamp below.
# The goal of this function is to provide a short function call 
...
0 & This paper (2022)         & $\Sexpr{f_car("Re_empl")}$
                              ...
                              & $\Sexpr{f_car("Re_tot")}$  \\
\midrule
1 & \citet{Borenstein:2015aa} &             & 13         & 11         &              &            &              &  \\
\midrule
2 & \citet{Thomas:2013ab}     &             &            &            &              & 10         &  6           &  \\
\midrule
3 & \citet{Chitnis:2015}      &             &            &            &              & 55         & 23           &  \\
\midrule
4 & \citet{Greene:1998aa}     &             &            &            &              & 20         &              &  \\
\midrule
5 & \citet{Greene:1998aa}     &             &            &            &              & 20         &              &  \\
\midrule
6 & \citet{Small:2005aa}      &             &            &            &              & 22         &              &  \\
\midrule
6 & \cite{Dimitropoulos:2018aa}      &             &            &            &              & 26--29         &              &  \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
