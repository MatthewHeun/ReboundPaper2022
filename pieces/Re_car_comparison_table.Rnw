...
4 & \citeauthor{Thomas:2013ab}  & U.S., & Expenditure/cross-price   & & & & & 10 & 6 &  \\
  & \citeyearpar{Thomas:2013ab} & 2004  & elasticities of transport & & & & &    &   &  \\
...
6 & \citeauthor{Chitnis:2015}  & UK,                       & Estimated own/cross-price  & & 72 & 5 & & 55 & 23 & 86 \\
  ...
  &                            &                           & spending survey data       & &    &   & &    &    &    \\
\midrule
7 & \citeauthor{Stapleton:2016}  & UK         & Elasticity of VMT w.r.t.\ & & & & & 9--36 & & \\
  & \citeyearpar{Stapleton:2016} & 1970--2011 & fuel cost/prices          & & & & &       & & \\
\midrule
8 & \citeauthor{Moshiri2017}  & Canada,    & Price elasticity of transport & & & & & 82--88 & & \\
  & \citeyearpar{Moshiri2017} & 1997--2009 & fuel, using household         & & & & &        & & \\
  &                           &            & spending survey data          & & & & &        & & \\
\midrule
9 & \citeauthor{Dimitropoulos:2018aa}  & Over half  & Meta study of 74 transport  &   &  &  & & 10--12      &  & \\
  & \citeyearpar{Dimitropoulos:2018aa} & are U.S.\  & direct rebound studies, all &   &  &  & & (short run) &  & \\
  &                                    & studies    & using elasticity-based      &   &  &            & & 26--29      &  & \\
  &                                    &            & methods                     &   &  &            & & (long run)  &  & \\
\midrule
