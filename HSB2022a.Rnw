...
(b)~missing from large climate models~\citep{Brockway:2021ww}.
...
\citet[p.~25]{Turner:2013aa} contends that the lack of consensus in the recent literature
on the magnitude of rebound is caused by 
...
for why rebound is not often included in large climate models~\citep{Brockway:2021ww}.
...
If the two disciplines cannot even agree on the terms, 
it is unsurprising that not enough progress has been made on understanding rebound.
...
A good place to start is the microeconomics of energy rebound.

Summarizing,
we surmise that reducing global carbon emissions has been hampered, in part, 
by the fact that rebound is not sufficiently included in climate models.
We suspect that rebound is not sufficiently included in climate models, because 
...
one that starts at the microeconomics of rebound and 
that is approachable for both engineers and economists.
The goal is deeper interdisciplinary understanding of the 
financial, behavioral, and energetic aspects of rebound.
