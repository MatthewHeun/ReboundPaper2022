...
empirical work on rebound began late in the decade~\citep{Madlener:2016to, Saunders:2021te}. 
...
a wide range of estimates of rebound, 
...
there is lack of consensus on rebound estimation methods and, hence, rebound magnitude.
...
The objective of this paper, then, is to provide the beginnings 
