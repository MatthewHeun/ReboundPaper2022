...
empirical work on rebound began late in that decade~\citep{Madlener:2016to, Saunders:2021te}, 
...
a wide variety of rebound estimation approaches yields
a wide range of estimates of rebound and the appearance of uncertainty,
leading energy and climate modelers to either 
(a)~use incorrect numbers, or 
(b)~ignore rebound altogether.
We suggest that 
improving the conceptual space around rebound and solidifying the analytical frameworks
will help to
(a)~generate better estimates of rebound,
(b)~lead to rebound being included in more energy and climate models, and 
...
economists need to have an engineer's understanding of energy, and 
engineers need to have an economist's understanding of finance and human behavior.
