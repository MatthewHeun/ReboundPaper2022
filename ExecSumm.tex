...
We apply the framework to two examples, energy efficiency upgrades 
%
\begin{enumerate*}[label={(\roman*)}]

  \item from a gasoline-powered vehicle to an electric vehicle and
  
  \item from an incandescent electric lamp to an LED electric lamp.
...
\begin{enumerate*}[label={(\roman*)}]
  ...
  \item For the two examples, total rebound is   
        more sensitive to
        the price of energy,
